    ...
    <>
      <div className="bg-white rounded-3xl p-12 shadow-xl mb-24">
        ...
        <p className="text-[#0F0E47]/80 text-center max-w-3xl mx-auto mb-12">
          ...
          make food distribution safe and convenient.
        </p>
  ...
  <div className="text-center px-6 max-w-4xl">
    ...
    >
      <span className="flex items-center gap-2">
        <FaRecycle /> 100% Reusable Products
      </span>
      <span className="flex items-center gap-2">
        <FaUsers /> Trained Eco Volunteers
      </span>
      <span className="flex items-center gap-2">
        <FaLeaf /> Zero Plastic Commitment
      </span>
    </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {packages.map((pkg, i) => (
            ...
            >
              ...
              <button className="mt-6 w-full bg-[#0F0E47] text-white py-2 rounded-lg">
...
<section className="bg-white text-[#0F0E47] py-24 px-6">
  ...
  <div className="max-w-2xl mx-auto bg-[#0F0E47] px-14 py-14 rounded-3xl shadow-2xl">
    <form className="space-y-6">
      ...
      <input
        className="w-full p-5 rounded-2xl bg-white text-[#0F0E47]
                   placeholder-[#0F0E47]/60 outline-none
      ...
      <input
        type="date"
        className="w-full p-5 rounded-2xl bg-white text-[#0F0E47]
                   outline-none focus:ring-2 focus:ring-white/40 transition"
      />
      ...
      <button
        className="w-full bg-white text-[#0F0E47] py-4 rounded-2xl
                   font-bold text-lg flex justify-center gap-2 items-center
                   transition shadow-lg hover:bg-white/90"
      >
        <FaPhoneAlt />
        Request Consultation
      </button>
